    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_image', models.ImageField(blank=True, max_length=255, null=True, upload_to='courses', verbose_name='封面图片')),
                ...
                ('discount_type', models.SmallIntegerField(choices=[(0, ''), (1, '折')], default=0, verbose_name='是否打折')),
                ('discount_price', models.DecimalField(decimal_places=2, default=0, max_digits=8, verbose_name='课程打折价格')),
                ('students', models.IntegerField(default=0, verbose_name='学习人数')),
                ('sections', models.IntegerField(default=0, verbose_name='总课时数量')),
                ('publish_sections', models.IntegerField(default=0, verbose_name='课时更新数量')),
            ],
            options={
                'verbose_name': '课程',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('course', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='course_chapters', to='course.course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='teacher', verbose_name='导师封面')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='course_sections', to='course.coursechapter', verbose_name='课程章节')),
            ],
            options={
                'verbose_name': '课时',
